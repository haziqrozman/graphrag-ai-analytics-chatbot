...
FROM 'C:\Users\User\graphrag-ai-analytics-chatbot\01_datasets\gold.dim_customers.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\Users\User\graphrag-ai-analytics-chatbot\01_datasets\gold.dim_products.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
...
FROM 'C:\Users\User\graphrag-ai-analytics-chatbot\01_datasets\gold.fact_sales.csv'
WITH (
	FIRSTROW = 2,
	FIELDTERMINATOR = ',',
	TABLOCK
